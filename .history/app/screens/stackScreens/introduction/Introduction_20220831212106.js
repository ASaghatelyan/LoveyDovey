    ...
    return (
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.bottomView}>
                <TouchableOpacity onPress={decriment} style={{paddingVertical:2,backgroundColor:'red'}}>
                ...
                <TouchableOpacity onPress={incriment} style={{paddingVertical:2,backgroundColor:'red'}}>
