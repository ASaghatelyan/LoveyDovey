                        ...
                        <View style={styles.itemView}>
                            <View style={styles.leftSide}>
                                <View style={{ position: 'relative' }}>
                                    <Image source={Math.floor(category.length * 14.3 <= 49) ?
                                        userh : Math.floor(category.length * 14.3 > 49) ?
                                            userh50 ? Math.floor(category.length * 14.3 > 75) :
                                                userh75 ? Math.floor(category.length * 14.3) > 99 : userh100 : null} style={styles.userH} />
                                    <Text style={styles.procent}>{(category.length * 14.3)}%</Text>
                                </View>
