                        ...
                        <View style={styles.itemView}>
                            <View style={styles.leftSide}>
                                <View style={{ position: 'relative' }}>
                                    Math.floor(4 * 14.3 <= 49) &&  <Image source={userh} style={styles.userH} />
                                    Math.floor(4 * 14.3 > 49) &&  <Image source={ userh50 } style={styles.userH} />
                                    Math.floor(4 * 14.3 > 75) &&   <<Image source={ userh50 } style={styles.userH} />
                                    Math.floor(4 * 14.3) > 99 &&  <Image source={ ?
                                        userh : ?
                                            userh50 ?  :
                                                userh75 ? Math.floor(4 * 14.3) > 99 : userh100 : null} style={styles.userH} />
