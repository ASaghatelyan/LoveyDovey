                        ...
                        <View style={styles.itemView}>
                            <View style={styles.leftSide}>
                                <View style={{ position: 'relative' }}>
                                    {Math.floor(6 * 14.3 <= 49) ? <Image source={userh} style={styles.userH} /> : Math.floor(6 * 14.3 > 49) ? 
                                    <Image source={userh50} style={styles.userH} /> : Math.floor(6 * 14.3 > 70) ? <Image source={userh75} style={styles.userH} /> 
                                    :null}
