                        ...
                        <View style={styles.itemView}>
                            <View style={styles.leftSide}>
                                <View style={{ position: 'relative' }}>
                                    {Math.floor(3 * 14.3 <= 49) ? <Image source={userh} style={styles.userH} /> : Math.floor(3 * 14.3 > 49 && 3 * 14.3 < 70) ? 
                                    <Image source={userh50} style={styles.userH} /> : Math.floor(3 * 14.3 > 70 && 3 * 14.3 <99) ? <Image source={userh75} style={styles.userH} /> 
                                    : Math.floor(3 * 14.3) > 99 ? <Image source={userh100} style={styles.userH} /> : null}
