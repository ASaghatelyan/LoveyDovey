...
export function HomeScreen(props) {
    ...
    const onGetLover = async () => {
        try {
            ...
            console.log(res.data.data, 'partnors');
        } catch (e) {
            setLoad(false)
            console.log(e, 'err3');
        }
                ...
                >
                    ...
                    <View style={styles.bottomView}>
                        ...
                        <View style={styles.itemView}>
                            ...
                            {partner?.email ? <Image source={me} style={styles.me} /> :
                        ...
                        <View style={styles.itemView}>
                            <View style={styles.leftSide}>
                                <View style={{ position: 'relative' }}>
                                    {Math.floor(category.length * 14.3 <= 49) ? <Image source={userh} style={styles.userH} /> : Math.floor(category.length * 14.3 > 49 && category.length * 14.3 < 70) ? 
                                    <Image source={userh50} style={styles.userH} /> : Math.floor(category.length * 14.3 > 70 && category.length * 14.3 <99) ? <Image source={userh75} style={styles.userH} /> 
                                    : Math.floor(category.length * 14.3) > 99 ? <Image source={userh100} style={styles.userH} /> : null} 
                                    <Text style={styles.procent}>{Math.floor(4 * 14.3)}%</Text>
                                </View>
