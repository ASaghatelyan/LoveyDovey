                        ...
                        <View style={styles.itemView}>
                            <View style={{ flex: 1 }}>
                                {chooseData.map((item, index) => {
                                    ...
                                    return ({flag ? <ProgressBar categoryName={item.name} procent='0' /> :  <ProgressBar categoryName={item.name} procent='0' />})
                                    // category.map((val, ind) => {
                                    //     if (item.id === val) { return <ProgressBar categoryName={item.name} color={item.color} procent='100' /> }
