                ...
                >
                    <View style={styles.titleView}>
                        ...
                        <View style={styles.gFlex}>
                            ...
                            <TouchableOpacity onPress={() => onGetLoverMatch([1, 2, 6, 3,])}>
                            ...
                            <View style={{ flex: 1 }}>
                                {chooseData.map((item, index) => {
                                    ...
                                    // }
                                        ...
                                        )<ProgressBar categoryName={`${item.status}`} color={item.color} procent='100' />
                                    return <ProgressBar categoryName={`${item.status}`} procent='0' /> }
