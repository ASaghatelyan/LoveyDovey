                        ...
                        <View style={styles.gFlex}>
                            ...
                            <TouchableOpacity onPress={() => props.navigation.navigate('Notification')}>
                                <View style={{position:'relative'}}>
                                    ...
                                    <View style={{position:'absolute',right:-5,top:-5,backgroundColor:'#EB1829',  borderRadius:100 ,width:15,alignItems:'center',justifyContent:'center',height:15,padding:2}}>
                                        <Text style={{fontSize:10,color:'#FFF'}}>22</Text>
                                    </View>
                                </View>
                            </TouchableOpacity>
                        </View>
