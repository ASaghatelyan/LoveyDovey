...
export function HomeScreen(props) {
    ...
    const onGetLoverMatch = async (arr1) => {
        ...
        try {
            ...
            console.log(res?.data?.data?.category_id,'res.data.data.category_id');
            setNotification(resNot.data.data)
            res.data.data.category_id ? setCategory([...res.data.data.category_id]) :setCategory([...res.data.data.category_id]) ;
