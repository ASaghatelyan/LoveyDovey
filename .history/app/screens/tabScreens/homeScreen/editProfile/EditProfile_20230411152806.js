        ...
        <View style={{ flex: 1, height: '100%' }} >
                    ...
                    <View style={styles.bottomView}>
                        <View style={styles.avatarView}>
                            <TouchableOpacity style={{ position: 'relative' }} onPress={() => {
                                ...
                                <Image source={img ? img : userInfo.user_details?.image ? { uri: userInfo.user_details.image } : user} style={styles.userAvatar} />
                                <View>
                        ...
                        <EditProfileItem name={userInfo.email} chooseStyle={userInfo.email && { color: '#403D3D' }} />
                    </View>
                </ScrollView>
            ...
            <DatePicker
                ...
                onConfirm={(date) => {
                    ...
                    setBthDay(moment(date).format('YYYY-MM-DD'))
                    setModalVisible(!modatlVisible)
                }}
                onCancel={() => {
                    setOpen(false)
