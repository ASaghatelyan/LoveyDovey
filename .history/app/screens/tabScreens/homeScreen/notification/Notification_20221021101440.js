        ...
        <View style={{ flex: 1, height: '100%', backgroundColor: 'red' }}>
            ...
            <SafeAreaView
                ...
                <ScrollView
                    ...
                    bounces={false}
                    contentContainerStyle={[styles.bottomView, data.length < 1 ? { justifyContent: 'center', alignItems: 'center' }:{backgroundColor:''}]}>
                            ...
                            {data.map((item, index) => {
                                return <View key={item.id}>
                                    <View>
                                        ...
                                        <Image style={styles.delIc} />
                                    </View>
                                    <Text style={styles.description}>kzdhjfbhjsdbfkavjsdfbvbsdfhvbsd sdfhbv shfvksdfbv shdfbv hjdsfb vsdhfbv sdhjfbv dsjkfhbv sdhfbv dskhbvsdkfhbv sdbv</Text>
                                </View>
                            })}
                        </View>}
                </ScrollView>
