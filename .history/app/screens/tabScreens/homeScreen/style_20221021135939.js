...
export const styles = StyleSheet.create({
    ...
    notiNumber:{position:'absolute',right:-5,top:-5,backgroundColor:'#EB1829',  borderRadius:100 ,width:15,alignItems:'center',justifyContent:'center',height:15,padding:2}
});
