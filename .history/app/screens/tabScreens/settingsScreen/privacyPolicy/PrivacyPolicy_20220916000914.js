            ...
            <SafeAreaView
                ...
                <ScrollView contentContainerStyle={styles.content}  >
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={styles.inputView}>
                        ...
                        <Text style={styles.text}>It is our policy to post any changes we make to our privacy policy on this page. If we make material changes to how we treat our users' personal information, we will notify you by email to the email address specified in your account. The date the privacy policy was last revised is identified at the top of the page. You are responsible for ensuring we have an up-to-date active and deliverable email address for you, and for periodically visiting our Services and this privacy policy to check for any changes.</Text>
                        <Text style={styles.title}>Contact Information</Text>
                        <Text style={styles.text}>To ask questions or comment about this privacy policy and our privacy practices, contact us at:
                            {"\n"}[EMAIL ADDRESS] </Text>
                    </ScrollView>
                </ScrollView>
            </SafeAreaView>
